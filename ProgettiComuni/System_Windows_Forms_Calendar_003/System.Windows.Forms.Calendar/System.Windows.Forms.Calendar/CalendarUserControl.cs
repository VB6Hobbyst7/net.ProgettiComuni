...
namespace System.Windows.Forms.Calendar
{
    public partial class CalendarUserControl : UserControl
    {
        ...
        public DateTime mvStartDate;
        public DateTime mvEndDate;
        

        public List<ItemInfo> ExternaItemsList = new List<ItemInfo>();

        public class ExtItemsList<ItemInfo>
        {
            private List<ItemInfo> externaItemsList;

            public List<ItemInfo> ExternaItemsList
            {
                get { return externaItemsList; }
                set { externaItemsList = value; }
            }
        }
        ...
        public void SetMonthViewStartEnd()
        {

            monthView1.SuspendLayout();

            if (mvStartDate != null)
                monthView1.SelectionStart = mvStartDate;

            if (mvEndDate != null)
                monthView1.SelectionEnd = mvEndDate;

            monthView1.ResumeLayout();
        }
        ...
        public void LoadCalendar()
        {
            ...
            {
                foreach (ItemInfo item in ExternaItemsList)
                {
        ...
        #region menucontestualemonthview
        //

        ContextMenu CMMonthView = new ContextMenu();

        void LoadMenuMV()
        {
            ContextMenuStrip CMMonthView = new ContextMenuStrip();
            ToolStripMenuItem menuItemWorkWeek = new ToolStripMenuItem("WorkWeek");
            menuItemWorkWeek.Click += new EventHandler(menuItemWorkWeek_Click);
            menuItemWorkWeek.Name = "WorkWeek";
            CMMonthView.Items.Add(menuItemWorkWeek);

            monthView1.ContextMenuStrip = CMMonthView;
            return;
        }

        private void menuItemWorkWeek_Click(object sender, EventArgs e)
        {
            monthView1.SelectionMode = MonthView.MonthViewSelection.WorkWeek;
        }
