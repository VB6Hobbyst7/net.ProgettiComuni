                            ...
                            //if (pair.Key.ToUpper() == attributo[0].ToUpper())
                            {
                                ...
                                if (bIntestazione == true)
                                {
                                    if (pair.Key.ToUpper().Contains("TIPO RILAVORAZIONE"))
                                    {
                                        ...
                                        else if (pair.Value.ToUpper() == "RIL")
                                        {
                                            // intestazione
                                        ...
                                        else //if (pair.Value.ToUpper() == "SEL")
                                        {
                                            cell = new PdfPCell(new Phrase(string.Format(intestazione, "SEGNALAZIONE")));
                                            cell.BackgroundColor = CMYKColor.ORANGE;
                                ...
                                if (pair.Value.ToString() != "")
                                {
                                    ...
                                    {
                                        if (pair.Key.ToUpper().Substring(0, pair.Key.IndexOf("|")) == attributo[0].ToUpper())
                                        {
                                    ...
                                    {
                                        if (pair.Key.ToUpper().Contains("R-M-O"))
                                        {
                                            PdfPCell xCell = new PdfPCell(new Phrase(attributo[1]));
